package com.cloud.alibaba.nacosnamespaceclient;
...
public class NacosNamespaceClientApplication {

    public static void main(String[] args) {
        SpringApplication.run(NacosNamespaceClientApplication.class, args);
    }
